...
* To handle desktop entry field codes the script currently strips everything except the first word out of the executable. This works for most entries, but some will not be processed correctly.
